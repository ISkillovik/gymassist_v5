...
const QuadRight = ({ counter, data, newPaddedDate }) => {
  ...
  const inputDateVal = data.userGym.lastData.quadRight;
  ...
  return (
    <div>
      <ParamInput
        ...
        title={"Right quad"}
      />
      {data.userGym.quadRight.length ? (
        <LineChartJS data={data.userGym.quadRight} title={"Right quad"} />
      ) : (
        <p>xuy</p>
      )}
    </div>
